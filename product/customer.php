...
<table id="ordersTable" class="table table-bordered table table-striped table-hover">
   ...
   ?>     
            ...
            <tr>
              <td><a href="updatecustomer.php?id=<?= $data['id']; ?>" type="button" class="btn btn-warning btn-sm"><i class="bi bi-wrench-adjustable"></i> แก้ไข</a></td>
              <td><a href="deletecustomer.php?id=<?= $data['id']; ?>"type="button"  class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> ลบ</a></td>
